                          ...
                          children: [
                            ...
                            Flexible(
                              child: FlutterFlowCheckboxGroup(
                                ...
                                controller:
                                    _model.departamentoValueController ??=
                                        FormFieldController<List<String>>(
                                  [],
                                ),
                                activeColor:
                            ...
                            Flexible(
                              child: FlutterFlowCheckboxGroup(
                                options: ['Sección'],
                                onChanged: (val) =>
                                    setState(() => _model.seccinValues = val),
                                controller: _model.seccinValueController ??=
                                    FormFieldController<List<String>>(
                                  [],
                                ),
                                activeColor:
                                ...
                                checkboxBorderRadius:
                                    BorderRadius.circular(4.0),
                                initialized: _model.seccinValues != null,
                              ),
                            ),
                          ],
                        ),
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              if (confirmDialogResponse) {
                                _model.retorno =
                                    await actions.chequearDuplicadosNombre(
                                  context,
                                ...
                                if (_model.retorno == 1) {
                                  ...
                                  await UsersRecord.collection
                                      ...
                                      .update(createUsersRecordData(
                                        password:
                                            _model.passwordTextController.text,
                                        isAdmin: (_model.administradorValues !=
                                                    null &&
                                                (_model.administradorValues)!
                                                    .isNotEmpty) ==
                                            true,
                                        email: _model.correoTextController.text,
                                        isDirector:
                                            (_model.directorValues != null &&
                                                    (_model.directorValues)!
                                                        .isNotEmpty) ==
                                                true,
                                        nombre:
                                            _model.nombreTextController.text,
                                        ...
                                        isSeccion:
                                            (_model.seccinValues != null &&
                                                    (_model.seccinValues)!
                                                        .isNotEmpty) ==
                                                true,
                                        isDepartamento:
                                            (_model.departamentoValues !=
                                                        null &&
                                                    (_model.departamentoValues)!
                                                        .isNotEmpty) ==
                                                true,
                                  ...
                                  await showDialog(
                                    ...
                                    builder: (alertDialogContext) {
                                      return AlertDialog(
                                        title: Text('Error'),
                                        content: Text(
                                            'El nombre ingresado ya esta ocupado'),
                                        actions: [
                                          TextButton(
                                            onPressed: () => Navigator.pop(
                                                alertDialogContext),
