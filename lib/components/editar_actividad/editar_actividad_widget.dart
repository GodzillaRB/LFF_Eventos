...
class EditarActividadWidget extends StatefulWidget {
  const EditarActividadWidget({
    ...
    required this.refEventos,
  });

  final DocumentReference? refActividad;
  final DateTime? horaInicio;
  final DateTime? horaFin;
  final DocumentReference? refEventos;
                  ...
                  children: [
                    Align(
                      ...
                      child: StreamBuilder<FfEventosRecord>(
                        stream: FfEventosRecord.getDocument(widget.refEventos!),
                        builder: (context, snapshot) {
                          // Customize what your widget looks like when it's loading.
                          if (!snapshot.hasData) {
                            return Center(
                          ...
                          final containerFfEventosRecord = snapshot.data!;
                          return Container(
                            width: 800.0,
                            decoration: BoxDecoration(
                                          ...
                                          child: Padding(
                                            ...
                                            child: TextFormField(
                                              controller:
                                                ...
                                                text: containerActividadesRecord
                                                    .nombre,
                                              ),
                                              focusNode:
                                                      ...
                                                      builder: (context) =>
                                                        ...
                                                        builder: (context,
                                                          ...
                                                          List<ResponsablesRecord>
                                                              dropDownResponsablesRecordList =
                                                              snapshot.data!;
                                                                ...
                                                                return Padding(
                                                                  padding: MediaQuery
                                                                      .viewInsetsOf(
                                                                          context),
                                                                  child:
                                                                      ActividadesAgendadasWidget(
                                                                    referenciaEspacioSolicitado:
                                                                        _model
                                                                            .dropDownValue2!,
                                                                    refDiaSolicitado:
                                                                        _model
                                                              ...
                                                              builder:
                                                                ...
                                                                return AlertDialog(
                                                                  title: Text(
                                                                      'Sin Actividas'),
                                                                  content: Text(
                                                                      'En este día no hay actividades programadas'),
                                                                  actions: [
                                                                    TextButton(
                                                                      onPressed:
                                                                          () =>
                                      ...
                                      onPressed: () async {
                                        ...
                                        if (confirmDialogResponse) {
                                          await containerActividadesRecord
                                            ...
                                            responsable: _model.dropDownValue1,
                                            cantidadInvitados: int.tryParse(
                                                _model.textController2.text),
                                            dia: _model.datePicked1,
                                            horaInicio: _model.datePicked2,
                                            horaFin: _model.datePicked3,
                                            croquis: _model.uploadedFileUrl,
                                          ));
                                        } else {
                                          await showDialog(
                                            context: context,
