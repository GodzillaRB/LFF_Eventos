                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          StreamBuilder<List<FfEventosRecord>>(
                            stream: queryFfEventosRecord(
                              queryBuilder: (ffEventosRecord) => ffEventosRecord
                                  .where(
                                    'estatus',
                                    isEqualTo:
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<FfEventosRecord>
                                  listViewFfEventosRecordList = snapshot.data!;
                              return ListView.builder(
                                padding: EdgeInsets.zero,
                                shrinkWrap: true,
                                scrollDirection: Axis.vertical,
                                itemCount: listViewFfEventosRecordList.length,
                                  ...
                                  return Visibility(
                                    visible: (valueOrDefault<bool>(
                                            ...
                                            valueOrDefault<bool>(
                                                ...
                                                false)) &&
                                        (listViewFfEventosRecord.estatus ==
                                            'Pendiente'),
                                    child: Padding(
                                        ...
                                        builder: (context) => InkWell(
                                          ...
                                          child: Container(
                                            ...
                                            decoration: BoxDecoration(
                                              ...
                                              border: Border.all(
                                                color: listViewFfEventosRecord.leido
                                                        .contains(
                                ...
                                itemBuilder: (context, listViewIndex) {
                                  final listViewFfEventosRecord =
                                      listViewFfEventosRecordList[
                                          listViewIndex];
                                  return Visibility(
                                    visible: (listViewFfEventosRecord.estatus ==
                                            'Aceptado') &&
                                        (currentUserReference ==
                                            listViewFfEventosRecord.idUsuario),
                                    child: Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 16.0, 0.0, 12.0),
                                      child: InkWell(
