...
import 'recursos_requeridos_model.dart';
export 'recursos_requeridos_model.dart';

class RecursosRequeridosWidget extends StatefulWidget {
  const RecursosRequeridosWidget({
    super.key,
    required this.refActividad,
  });

  final DocumentReference? refActividad;

  @override
  State<RecursosRequeridosWidget> createState() =>
      _RecursosRequeridosWidgetState();
}

class _RecursosRequeridosWidgetState extends State<RecursosRequeridosWidget> {
  late RecursosRequeridosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RecursosRequeridosModel());
                ...
                children: [
                  Flexible(
                    child: StreamBuilder<ActividadesRecord>(
                      stream:
                          ActividadesRecord.getDocument(widget.refActividad!),
                                                                ...
                                                                child: StreamBuilder<
                                                                  ...
                                                                  builder: (context,
                                                                    ...
                                                                    return FlutterFlowDropDown<
                                                                      ...
                                                                      options: dropDownDepartamentosRecordList
                                                                          .map((e) =>
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return GestureDetector(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: AgregarMaterialWidget(
                                                                                refDepartamento: _model.dropDownValue1!,
                                                                              ),
                                                                            ),
                                                                          );
                                                                        },
                                                    ...
                                                    child: StreamBuilder<
                                                      ...
                                                      builder:
                                                        ...
                                                        return Container(
                                                          ...
                                                          child: Builder(
                                                            builder: (context) {
                                                              final queryRecursos = containerRecursosRecordList
                                                              ...
                                                              return FlutterFlowDataTable<
                                                                ...
                                                                dataRowBuilder: (queryRecursosItem,
                                                                        queryRecursosIndex,
                                                                        selected,
                                                                        onSelectChanged) =>
                                                                    DataRow(
                                                                  ...
                                                                  cells: [
                                                                    StreamBuilder<
                                                                        MaterialesRecord>(
                                                                      stream: MaterialesRecord.getDocument(
                                                                          queryRecursosItem
                                                                              .refMateriales!),
                                                                      builder:
                                                                          (context,
                                                                      ...
                                                                      children: [
                                                                        InkWell(
                                                                          ...
                                                                          onTap:
                                                                            ...
                                                                            if (confirmDialogResponse) {
                                                                              await queryRecursosItem.reference.delete();
                                                                            }
                                                                          },
                                                                          child:
                                                                              Icon(
                                                                            Icons.delete_sharp,
                                                                            color:
                                                                                FlutterFlowTheme.of(context).delete,
                                                                            size:
                                                                                24.0,
                                                                          ),
                                                                        ),
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            Icons.edit_square,
                                                                            color:
                                                                                FlutterFlowTheme.of(context).edit,
                                                                            size:
                                                                                24.0,
                                                                          ),
                                                                        ),
