        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () async {
            if (valueOrDefault<bool>(
                    currentUserDocument?.isDepartamento, false) ==
                true) {
            ...
            if (responsiveVisibility(
              ...
              wrapWithModel(
                ...
                child: BarraNavegacionWidget(
                  ...
                  eightGB: FlutterFlowTheme.of(context).bgFondoBotonNav,
                  eightIcon: Icon(
                    Icons.mode,
                  ...
                  eightLetter: FlutterFlowTheme.of(context).white,
                ),
              ),
            Expanded(
              child: Column(
                                    ...
                                    child: Builder(
                                      builder: (context) {
                                        ...
                                        return FlutterFlowDataTable<
                                          ...
                                          dataRowBuilder: (queryMaterialesItem,
                                                  queryMaterialesIndex,
                                                  selected,
                                                  onSelectChanged) =>
                                              DataRow(
                                            color: MaterialStateProperty.all(
                                              queryMaterialesIndex % 2 == 0
                                                  ? FlutterFlowTheme.of(context)
                                                      .secondaryBackground
                                                  : FlutterFlowTheme.of(context)
                                                      .secondaryBackground,
                                            ...
                                            cells: [
                                              ...
                                              AutoSizeText(
                                                queryMaterialesItem.descripcion,
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
                                                        .override(
